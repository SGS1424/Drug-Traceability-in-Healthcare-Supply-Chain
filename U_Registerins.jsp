...
<head>
<title>Patient Register Status...</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style30"><span class="header_01 style6">Patient Registration Status..</span></h2>
          <div class="clr"></div>         
...
else
{
            ...
            <br />
            <br />
            <p align="center" class="style24 style31">Patient Name Already Exist..</p>
            <br />
