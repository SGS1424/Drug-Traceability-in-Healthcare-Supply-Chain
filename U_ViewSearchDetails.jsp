...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
   <h1 class="style2">Searched <span class="style4">Drug</span> <span class="style18"><%=request.getParameter("p_Name")%></span> Details</h1>
                <p class="style6">&nbsp;</p>
                <p>
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								    <td width="160" rowspan="7" bgcolor="#FFFFFF" ><div class="style22 style4 style5 style3" style="margin:10px 13px 10px 13px;" > 
								...
								<tr>
						          ...
						          <td><div align="center" class="style3"><span class="style17"><a href="U_Comment.jsp?p_name=<%=p_Name%>">Comment</a></span></div></td>
								</tr>
								<tr>
										
						          <td><div align="center" class="style3"><span class="style17"><a href="Buy_Verification.jsp?p_name=<%=p_Name%>&id=<%=i%> ">BUY</a></span></div></td>
								</tr>
