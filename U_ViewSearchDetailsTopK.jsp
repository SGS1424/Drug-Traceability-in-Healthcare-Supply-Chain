...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
   <h2>Searched <span class="style4">Drug</span> <span class="style18"><%=request.getParameter("p_Name")%></span> Details</h2>
                <p class="style6">&nbsp;</p>
                <p>
	...
	if ( rs.next() )
	   {
		...
		Statement st32 = connection.createStatement();
		 String query32 ="update search set rank=rank+1 where p_id='"+i+"' and keyword='"+Keyword+"' and p_name='"+p_Name+"' ";
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
							      ...
							      <td width="85"><div align="center"><span class="style17" style="color:#000000;"><%= p_Name%></span></div></td>
		  						<tr/>
								...
								<tr>
						          ...
						          <td><div align="center" class="style2"><span class="style17"><a href="U_Comment1.jsp?p_name=<%=p_Name%>">Comment</a></span></div></td>
								</tr>
								<tr>
										
						          <td><div align="center" class="style2"><span class="style17"><a href="Buy_Verification.jsp?p_name=<%=p_Name%>&id=<%=i%> ">BUY</a></span></div></td>
								</tr>
