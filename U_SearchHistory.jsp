...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2 class="style2">Patient <span class="style18 style18"><%=(String)application.getAttribute("uname")%></span> Search History </h2>
	 <table width="598" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
        <tr>
          ...
          <td  width="110" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style15 style6 style8 style7 style22 style3"><span class="style4">Drug</span> Name </div></td>
          <td  width="117" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style15 style6 style8 style7 style22 style3"><span class="style4">Drug</span> Categorie</div></td>
          ...
          <td  width="145" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style15 style6 style8 style7 style22 style3">Date</div></td>
		   <td  width="145" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style15 style6 style8 style7 style22 style3">Image</div></td>
        </tr>
