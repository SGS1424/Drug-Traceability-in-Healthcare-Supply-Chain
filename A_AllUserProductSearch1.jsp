...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								  ...
								  <div align="center" class="style3"><span class="style17">Drug Name</span> </div></td>
								    <td width="74" bgcolor="#FFFFFF"><div align="center" class="style2"><span class="style17"><%=name%></span></div></td>
		  						<tr/>
				    
				    
				    			<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
						  		  <div align="center" class="style3"><span class="style17">Drug Categorie</span> </div></td>
								    <td bgcolor="#FFFFFF"><div align="center" class="style2"><span class="style17"><%= categorie%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
						  		  <div align="center" class="style3"><span class="style17">Drug Price</span> </div></td>
								    <td bgcolor="#FFFFFF"><div align="center" class="style2"><span class="style17"><%= p_Price%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style3"><span class="style17">Drug Rank </span> </div></td>
								    <td bgcolor="#FFFFFF"><div align="center" class="style2"><span class="style17"><%= p_Rank%></span></div></td>
				    			</tr>
								<tr>
										<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style3"><span class="style17">Drug Description </span></div></td>
					...
					%>
 					...
 					<div align="right"><a href="A_AllUsersProductSearch.jsp">Back</a></div>
	  </div>
    </div>
      <div class="sidebar">
        <div class="gadget">
