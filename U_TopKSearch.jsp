...
<head>
<title>Top K Searched Posts...</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	 ...
	 <FORM ACTION="U_TopKSearch.jsp" METHOD="post">
                    ...
                    <TR>
                      <TD width="139"><div align="center" class="style3">
                        <div align="right" class="style12">
                          <div align="center">Select Top 'K' <span class="style4">Drug</span>s </div>
                        </div>
                      </div></TD>
                      <TD width="187">
      	...
      	try 
	{
        ...
        <div align="center" class="style11"><span class="style4">Drug Name : </span><span class="style15"> <%=p_Name%></span></div></p>
               <p> 
               <div align="center" class="style11"><span class="style4">Drug Categorie</span> <span class="style15"> : <span class="style16"><%=categorie%></span></span></div>
               </p>
                <p>
                <div align="center" class="style11"><span class="style4">Drug Rank : </span> <span class="style15"> <%=Rank%></span></div></p>
                <p><div align="center" class="style5 style14"><span class="style11">View <a href="U_ViewSearchDetailsTopK.jsp?p_Name=<%=p_Name%>">Details</a></span></div></p>
                <p></p>
				<div>
