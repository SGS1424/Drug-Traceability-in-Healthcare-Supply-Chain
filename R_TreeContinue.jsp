	...
	if ( rs.next() )
	   {
		...
		st11.executeUpdate("update search set rank=rank+1 where user='"+uname+"' and keyword='"+name+"' ");
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								  ...
								  <div align="center" class="style2"><span class="style17"><span class="style4">Drug</span> Name</span> </div></td>
							      <td width="94"><div align="center"><span class="style17" style="color:#000000;"><%=name%></span></div></td>
		  						<tr/>
				    
				    
				    			<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
						  		  <div align="center" class="style2"><span class="style17"><span class="style4">Drug</span> Categorie</span> </div></td>
								    <td><div align="center"><span class="style17" style="color:#000000;"><%= categorie%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
						  		  <div align="center" class="style2"><span class="style17"><span class="style4">Drug</span> Price</span> </div></td>
								    <td><div align="center"><span class="style17" style="color:#000000;"><%= p_Price%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style2"><span class="style17"><span class="style4">Drug</span> Rank </span> </div></td>
								    <td><div align="center"><span class="style17" style="color:#000000;"><%= p_Rank%></span></div></td>
				    			</tr>
								<tr>
										<td width="187" height="27" bgcolor="#FFFFFF">
								  <div align="center" class="style2"><span class="style17"><span class="style4">Drug</span> Description </span></div></td>
								        <td><div align="center"><span class="style17" style="color:#000000;"><%= p_Desc1%></span></div></td>
								</tr>
								<tr>
										
						          <td><div align="center" class="style2"><span class="style17 style2"><a href="U_Comment.jsp?p_name=<%=name%>">Comment</a></span></div></td>
								</tr>
								<tr>
										
						          <td><div align="center" class="style2"><span class="style17"><a href="Buy_Verification.jsp?p_name=<%=name%>&id=<%=i%> ">BUY</a></span></div></td>
								</tr>
    ...
    <div align="right"><a href="R_Tree.jsp">Back</a></div>
