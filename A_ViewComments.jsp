...
<div class="main">
 ...
 <table width="604" height="88" border="2" cellpadding="2" cellspacing="2">
             <tr bgcolor="#0099FF">
			 <td width="113" height="30" bgcolor="#FFFFFF"><div align="center" class="style129 style3">ID</div></td>
			 <td width="113" height="30" bgcolor="#FFFFFF"><div align="center" class="style129 style3">Drug Name</div></td>
              <td width="113" height="30" bgcolor="#FFFFFF"><div align="center" class="style129 style3">User</div></td>
              <td width="333" bgcolor="#FFFFFF"><div align="center" class="style130 style3">
                  <div align="center"><strong>Comment</strong></div>
              </div></td>
              <td width="128" bgcolor="#FFFFFF"><div align="center" class="style118 style3"><span class="style128">Date</span></div></td>
			  <td width="128" bgcolor="#FFFFFF"><div align="center" class="style118 style3"><span class="style128">Image</span></div></td>
            </tr>
			...
			try
			{
			               ...
			               String query1="select * from comments";
					   		...
					   		while ( rs1.next() )
					   		{
								...
								%>
            <tr>
			 <td height="44" bgcolor="#FFFFFF"><div align="center" class="style124 style3">
                  <%out.println(i);%>
              </div></td>
